    ...
    `;var c,l}_toggleDescription(){this._isDescriptionExpanded=!this._isDescriptionExpanded}_renderItem(e){const t=this._getItemImage(e),i=e.summary||e.description||"",o=!1!==this._config.show_item_image&&!!t,n=o?i.replace(/<img[^>]*>/gi,""):i,s=new Date(e.published),r=ke(s,this.hass),a=this._config.new_pill_duration_hours??1,c=((new Date).getTime()-s.getTime())/6e4,l=c>=0&&c<60*a,h=this._storageHelper.isBookmarked(e),d=e.audio,p=d?this._storageHelper.getAudioProgress(d):null,_=p?.completed??!1;let m=we(this.hass,"component.rss-accordion.card.listened");if(_&&p?.completedAt){const e=ke(p.completedAt,this.hass);m=we(this.hass,"component.rss-accordion.card.listened_on",{date:e})}const u={aspectRatio:this._config.image_ratio,objectFit:this._config.image_fit_mode||"cover"};return q`
      <details class="accordion-item">
        ...
        <div class="accordion-content">
          ${(void 0!==this._config.show_source?this._config.show_source:this._entities.length>1)&&e.source_entity_id?q`<div class="item-source">
